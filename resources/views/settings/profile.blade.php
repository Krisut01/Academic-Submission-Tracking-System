                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ml-2">Profile Settings</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="lg:col-span-3">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                        <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Update Profile Information</h3>
                        ...
                        <div class="p-6">
                            <form method="POST" action="{{ route('settings.profile.update') }}" class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Your role cannot be changed. Contact an administrator if needed.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="created_at" value="{{ $user->created_at->format('F j, Y \a\t g:i A') }}" disabled
                                           class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-600 text-gray-500 dark:text-gray-400">
                                </div>
