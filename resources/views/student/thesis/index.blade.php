        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                ...
                <div class="thesis-card bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div class="p-8 card-content">
                        <!-- Icon Header -->
                        <div class="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl shadow-lg mb-6 mx-auto">
                            <svg class="w-8 h-8 text-gray-900 dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                            </svg>
                        </div>
                        
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4 text-center">Evaluation Form</h3>
                        <p class="text-base text-gray-600 dark:text-gray-400 mb-6 text-center leading-relaxed">Submit your academic evaluation form with completed subjects and thesis status.</p>
                        
                        <!-- Requirements List -->
                        <div class="bg-purple-50 dark:bg-purple-900/20 rounded-2xl p-4 mb-8">
                            <h4 class="font-semibold text-purple-900 dark:text-purple-300 mb-3">Required Information:</h4>
                            <ul class="text-sm text-purple-800 dark:text-purple-400 space-y-2">
                                <li class="flex items-center">
                        ...
                        <a href="{{ route('student.thesis.create', ['type' => 'evaluation_form']) }}" 
                           class="thesis-btn evaluation w-full text-gray-900 dark:text-white px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-200 flex items-center justify-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                            </svg>
                            Submit Evaluation
