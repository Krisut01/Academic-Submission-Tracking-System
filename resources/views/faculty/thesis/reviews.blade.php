                ...
                <form method="GET" action="{{ route('faculty.thesis.reviews') }}" class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="flex items-end space-x-3">
                            <button type="submit" class="flex-1 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-sm hover:shadow-md border-2 border-blue-600 hover:border-blue-700">
                                <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                                </svg>
                                Search
                            </button>
                            <a href="{{ route('faculty.thesis.reviews') }}" class="px-4 py-3 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-sm hover:shadow-md border-2 border-gray-600 hover:border-gray-700">
                ...
                <div class="p-6">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex flex-col space-y-2 ml-4 flex-shrink-0">
                                            <a href="{{ route('faculty.thesis.show', $document) }}" 
                                               class="inline-flex items-center justify-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg font-semibold text-sm transition-all duration-200 shadow-sm hover:shadow-md">
                    ...
                    @else
                        <div class="text-center py-16">
                            ...
                            @if(request()->hasAny(['document_type', 'status', 'student_search']))
                                <a href="{{ route('faculty.thesis.reviews') }}" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold transition-all duration-200 shadow-sm hover:shadow-md">
                                    Clear Filters
                                </a>
                            @endif
                        </div>
